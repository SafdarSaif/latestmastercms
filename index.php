...
$logo_url = 'admin/assets/images/default-logo.png';
...
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="admin/assets/" data-template="vertical-menu-template" data-style="light">
      ...
      <div class="authentication-inner py-6">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="form-login" class="mb-4" action="admin/app/login/login" method="post">
