	...
	$(function() {
		...
		if (dataTablethemesetting.length) {
			dt_permission = dataTablethemesetting.DataTable({
					...
					},
					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<input type="checkbox" ' +
								$checkedStatus +
								' class="switch-input" onclick="updateActiveStatus(\'/admin/app/status/update\', \'theme_settings\', ' + id + ')">' +
...

					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<button class="btn btn-sm btn-icon me-2" onclick="edit(\'themesetting\', ' + id + ', \'modal-lg\')">' +
								'<i class="ti ti-edit"></i>' +
								'</button>' +
								'<button class="btn btn-sm btn-icon delete-record" onclick="destroy(&#39;/admin/app/themesetting/destroy&#39;, ' + id + ')">' +
				...
				buttons: [{
					text: 'Add Theme Setting',
					className: 'add-new btn btn-primary mb-3 mb-md-0 waves-effect waves-light',
					attr: {
						'onclick': "add('app/themesetting/create.php', 'modal-lg')"
...
<h4 class="mb-4">Theme Setting</h4>

<!-- Admission Table -->
<div class="card">
	<div class="card-datatable table-responsive">

		<table id="themesetting-table" class="table border-top">
			<thead>
				<tr>
					<th>No.</th>
					<th>Name</th>
