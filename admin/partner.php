...
<script type="module">
	$(function() {
		var dataTablepartners = $('#partners-table'),
			dt_permission;
		// Users List datatable
		if (dataTablepartners.length) {
			dt_permission = dataTablepartners.DataTable({
				ajax: {
					'url': '/admin/app/partners/server.php',
					'type': 'POST',
					...
					},
					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<input type="checkbox" ' +
								$checkedStatus +
								' class="switch-input" onclick="updateActiveStatus(\'/admin/app/status/update\', \'partners\', ' + id + ')">' +
				...
				buttons: [{
					...
					attr: {
						'onclick': "add('app/partners/create.php', 'modal-lg')"
...
<h4 class="mb-4">Partner List</h4>

<!-- Admission Table -->
<div class="card">
	<div class="card-datatable table-responsive">

		<table id="partners-table" class="table border-top">
			<thead>
				<tr>
					<th>No.</th>
					<th>Name</th>
