...
function getChildDropdownData($conn, $modalID)
{
    ...
    //     FROM setting_data 
    //     JOIN setting_dependency 
    //     ON setting_dependency.Child_ID = setting_data.Heading_Setting_ID 
...
<div class="modal-body p-4">
    <div class="text-center mb-4">
        <h3 class="fw-bold text-primary">Add <?= $modalTitle ?></h3>
        <p class="text-muted">Fill in the details to create a new <?= $modalTitle ?> with ease.</p>
    </div>
    <form id="form-add-setting" action="/admin/app/setting/store" method="POST" enctype="multipart/form-data">
        ...
        <?php
        // echo "<pre>";
        // echo "The ParentID  is: " . $parentID;
        // echo "</pre>";
        // echo "<pre>";
        // print_r($dependencyData);
        // echo "</pre>";
        // Debugging Parent_ID from $dependencyData
        if (isset($dependencyData['Parent_ID'])) {
            echo "<pre>";
        ...
        <div class="row">
            ...
            <!-- <div class="mb-3 col-md-6">
                <input type="text" class="form-control" name="name" placeholder="Parent ID  <?= isset($parentID) ? $parentID : '' ?> " required>
            </div> -->
            <!-- Name Field -->
            <div class="mb-3 col-md-6">
