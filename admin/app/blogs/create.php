...
<div class="modal-body p-4">
  <div class="text-center mb-4">
    <h3 class="fw-bold text-primary">Create Blog</h3>
    <p class="text-muted">Fill in the details to create a new blog with ease.</p>
  </div>
  <form id="form-add-blogs" action="/admin/app/blogs/store" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
    <!-- Blog Name -->
    <div class="col-12">
      <label class="form-label fw-semibold" for="name">Blog Name <span class="text-danger">*</span></label>
      <input type="text" id="name" name="name" class="form-control border-primary shadow-sm" placeholder="Enter blog name" required autofocus />
    ...
    <div class="col-12">
      ...
      <textarea id="description" name="description" class="form-control border-primary shadow-sm" rows="3" placeholder="Enter a short description" required></textarea>
    ...
    <div class="col-12">
      ...
      <textarea id="editor" name="editor" class="ckeditor border-primary" required></textarea>
