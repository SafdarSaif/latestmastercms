...
<div class="modal-body p-4">
  <div class="text-center mb-4">
    <h3 class="fw-bold text-primary">Add Blog FAQ</h3>
    <p class="text-muted">Fill in the details to add a new FAQ for blogs.</p>
  </div>
  <form id="form-add-faq" action="/admin/app/blogfaq/store" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
    <!-- Blog Selection -->
    <div class="col-12">
    ...
    <div class="col-12">
      ...
      <input type="text" id="question" name="question" class="form-control border-primary shadow-sm" placeholder="Enter a question" required>
