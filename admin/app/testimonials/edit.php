...
<div class="modal-body p-4">
  <div class="text-center mb-4">
    <h3 class="fw-bold text-primary">Edit Testimonial</h3>
    <p class="text-muted">Update the details of the testimonial easily.</p>
  </div>

  <div class="form-validation">
    <form class="needs-validation" id="form-edit-testimonial" action="/admin/app/testimonials/update" method="POST" enctype="multipart/form-data">
...
<div class="modal-footer text-end">
  <button type="submit" form="form-edit-testimonial" class="btn btn-primary px-4 shadow-sm">Save</button>
