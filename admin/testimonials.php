...
<script type="module">
	$(function() {
		var dataTabletestimonials = $('#testimonials-table'),
			dt_permission;
		// Users List datatable
		if (dataTabletestimonials.length) {
			dt_permission = dataTabletestimonials.DataTable({
				ajax: {
					'url': '/admin/app/testimonials/server.php',
					'type': 'POST',
					...
					},
					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<input type="checkbox" ' +
								$checkedStatus +
								' class="switch-input" onclick="updateActiveStatus(\'/admin/app/status/update\', \'testimonials\', ' + id + ')">' +
...

					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<button class="btn btn-sm btn-icon me-2" onclick="edit(\'testimonials\', ' + id + ', \'modal-lg\')">' +
								'<i class="ti ti-edit"></i>' +
								'</button>' +
								'<button class="btn btn-sm btn-icon delete-record" onclick="destroy(&#39;/admin/app/testimonials/destroy&#39;, ' + id + ')">' +
				...
				buttons: [{
					...
					attr: {
						'onclick': "add('app/testimonials/create.php', 'modal-lg')"
