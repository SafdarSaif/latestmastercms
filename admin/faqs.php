...
<script type="module">
	$(function() {
		var dataTablefaqs = $('#faqs-table'),
			dt_permission;
		// Users List datatable
		if (dataTablefaqs.length) {
			dt_permission = dataTablefaqs.DataTable({
				ajax: {
					'url': '/admin/app/faqs/server.php',
					'type': 'POST',
					...
					},
					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<input type="checkbox" ' +
								$checkedStatus +
								' class="switch-input" onclick="updateActiveStatus(\'/admin/app/status/update\', \'faqs\', ' + id + ')">' +
					...
					},
					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<button class="btn btn-sm btn-icon me-2" onclick="edit(\'faqs\', ' + id + ', \'modal-lg\')">' +
								'<i class="ti ti-edit"></i>' +
								'</button>' +
								'<button class="btn btn-sm btn-icon delete-record" onclick="destroy(&#39;/admin/app/faqs/destroy&#39;, ' + id + ')">' +
				...
				buttons: [{
					text: 'Add Website Faqs',
					className: 'add-new btn btn-primary mb-3 mb-md-0 waves-effect waves-light',
					attr: {
						'onclick': "add('app/faqs/create.php', 'modal-lg')"
