...
<script type="module">
	$(function() {
		var dataTablepages = $('#pages-table'),
			dt_permission;
		// Users List datatable
		if (dataTablepages.length) {
			dt_permission = dataTablepages.DataTable({
				ajax: {
					'url': '/admin/app/pages/server.php',
					'type': 'POST',
					...
					},
					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<input type="checkbox" ' +
								$checkedStatus +
								' class="switch-input" onclick="updateActiveStatus(\'/admin/app/status/update\', \'pages\', ' + id + ')">' +
...

					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<button class="btn btn-sm btn-icon me-2" onclick="edit(\'pages\', ' + id + ', \'modal-lg\')">' +
								'<i class="ti ti-edit"></i>' +
								'</button>' +
								'<button class="btn btn-sm btn-icon delete-record" onclick="destroy(&#39;/admin/app/pages/destroy&#39;, ' + id + ')">' +
				...
				buttons: [{
					...
					attr: {
						'onclick': "add('app/pages/create.php', 'modal-lg')"
...
<div class="card">
	<div class="card-datatable table-responsive">
		...
		<table id="pages-table" class="table border-top">
			<thead>
				<tr>
					<th>No.</th>
					<th>Name</th>
