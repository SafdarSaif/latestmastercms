      ...
      <div class="authentication-inner py-6">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="form-forgot-password" class="mb-6" action="" method="POST">
              <div class="mb-6">
    ...
    <div class="modal-dialog  modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <button id="verifyOtpBtn" class="btn btn-success mt-3 w-100">Verify OTP</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="resetPasswordForm">
            ...
            <!-- <div class="mb-3">
              <label for="email" class="form-label">Email</label>
              <input type="email" class="form-control" id="emailHidden" name="email" required>
            </div> -->
            <div class="mb-3">
    ...
    $(document).ready(function() {
      ...
      $('#resetPasswordForm').on('submit', function(e) {
        ...
        if (newPassword === confirmPassword) {
          ...
          $.ajax({
            type: 'POST',
            url: 'app/otp/reset_password.php',
            data: {
