...
<script type="module">
	$(function() {
		var dataTableblogs = $('#blogs-table'),
			dt_permission;
		...
		if (dataTableblogs.length) {
			dt_permission = dataTableblogs.DataTable({
					...
					},
					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<input type="checkbox" ' +
								$checkedStatus +
								' class="switch-input" onclick="updateActiveStatus(\'/admin/app/status/update\', \'blogs\', ' + id + ')">' +
...

					{
						...
						render: function(data, type, full, meta) {
							...
							return (
								...
								'<button class="btn btn-sm btn-icon me-2" onclick="edit(\'blogs\', ' + id + ', \'modal-lg\')">' +
								'<i class="ti ti-edit"></i>' +
								'</button>' +
								'<button class="btn btn-sm btn-icon delete-record" onclick="destroy(&#39;/admin/app/blogs/destroy&#39;, ' + id + ')">' +
				...
				buttons: [{
					...
					attr: {
						'onclick': "add('app/blogs/create.php', 'modal-lg')"
...
<div class="card">
	<div class="card-datatable table-responsive">
		...
		<table id="blogs-table" class="table border-top">
			<thead>
				<tr>
					<th>No.</th>
					<th>Name</th>
